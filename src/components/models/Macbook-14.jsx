...
Files: macbook-14.glb [629.72KB] > C:\Users\aswam\WebstormProjects\macbook_gsap_app\public\models\macbook-14-transformed.glb [627.9KB] (0%)
  ...
  const texture = useTexture('/screen.png');
    ...
    useEffect(() => {
        scene.traverse((child) => {
            if(child.isMesh) {
                // Color maattende partkal mathram select cheyidh maatukaa !!
